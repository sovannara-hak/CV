...
+33 6 81 13 47 04\\
10 allée d'argoat, 31770 Colomiers, FRANCE\\
...
\Date{June 2006} 
\Duree{3 months}
\Lieu{Technical Training, Évry - France} 
\Titre{Laboratoire IBISC (Informatique Biologie Intégratives et Systèmes Complexes).} 
...
\begin{rubrique}{\color{violet}Education}
        \begin{sousrubrique}
                \Date{2008 - 2011} 
		\Titre{PhD in Robotics at INSA Toulouse (Institut National des Sciences Appliquées de Toulouse)}
        ...
        \begin{sousrubrique}
                \Date{2007 - 2008} 
		\Titre{Master of Science in Computer Science at Université Paris-Sud 11}
        ...
        \begin{sousrubrique}
                \Date{2004 - 2007}
                \Titre{Engineer degree at ENSIIE (Ecole Nationale Supérieure d'Informatique pour
                l'Industrie et l'Entreprise) recruiting through the Centrale-Supélec entrance examination}
...
\begin{rubrique}{\color{violet}Publications}
  ...
  \end{sousrubrique}
  \begin{sousrubrique}
    \Descr{{\color{gris}O. Ramos, L. Saab, \textbf{S. Hak} and N. Mansard, ``Dynamic Motion Capture and Edition
  ...
  \end{sousrubrique}
  \begin{sousrubrique}
    \Descr{\textbf{S. Hak}, N. Mansard and O. Stasse, ``Identification de T\^aches pour le Contr\^ole d'un Robot Humanoïde", in \emph{Journées Nationales de la Robotique Humanoïde, (Poitiers, France)}, June 2010}
  \end{sousrubrique}
\end{rubrique}

\renewcommand{\FonteTitre}{\scshape}
\begin{rubrique}{\color{violet}Referees}
  \begin{sousrubrique}
